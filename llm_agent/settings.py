...
# O campo "estrategia", reinjetado todo dia. O modelo escreve em bullets, e o teto
# vale para o bloco inteiro: conta os "- " e as quebras de linha.
STRATEGY_MAX_CHARS = 260
